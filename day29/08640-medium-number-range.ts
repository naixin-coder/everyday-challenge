...
// ============= Your Code Here =============
type IndexArray<L, C extends any[] = [], H = 0> = L extends C["length"]
  ? [...C, L][number]
  : IndexArray<L, [...C, H], [...C, H]["length"]>;
type NumberRange<L, H> = L | Exclude<IndexArray<H>, IndexArray<L>>;

type T = NumberRange<2, 9>;
type TI = IndexArray<2>;
